...
TEST_CASE("Check Discrete Frechet 1", "[discrete_frechet_1]")
{
    ...
    movetk_core::ComputeDiscreteFrechetDistance<MovetkGeometryKernel, Norm> discrete_frechet;
    MovetkGeometryKernel::NT distance = discrete_frechet(std::begin(polyline1), std::end(polyline1),
...
TEST_CASE("Check Discrete Frechet 4", "[discrete_frechet_4]")
{
    movetk_core::MakePoint<MovetkGeometryKernel> make_point;
    typedef std::vector<MovetkGeometryKernel::MovetkPoint> PolyLine;
    PolyLine polyline1({make_point({3, 7}), make_point({6, 5}),
                        make_point({10, 8}), make_point({10.68, 9.76}),
                        make_point({13, 6}), make_point({15, 9}),
                        make_point({16, 5}), make_point({19, 6})});

    PolyLine polyline2({make_point({4, 5}), make_point({8.68, 6.08}),
                        make_point({9, 9}), make_point({11, 7}),
                        make_point({14, 4}), make_point({18, 7})});

    PolyLine polyline3({make_point({3, 6}), make_point({6, 6}),
                        make_point({10, 6}), make_point({12, 6}),
                        make_point({15, 6}), make_point({18, 6}),
                        make_point({20, 6})});
