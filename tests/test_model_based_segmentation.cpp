...
//
//
//TEST_CASE("brownian bridge model segmentation 1", "[test brownian bridge model segmentation 1]") {
...
//
//	Norm norm;
//	typedef movetk::algo::brownian_bridge::ParameterTraits<MovetkGeometryKernel, decltype(t.begin())> ParameterTraits;
...
//
//	typedef movetk::algo::brownian_bridge::Model<MovetkGeometryKernel, ProbeTraits, ParameterTraits, Norm, Projection>
//	    BBMM;
//
...
//	}
//
//	typedef movetk::algo::brownian_bridge::LogLikelihood<MovetkGeometryKernel, ParameterTraits, Norm> LogLikelihood;
//
