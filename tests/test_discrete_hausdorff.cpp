...
TEST_CASE("Check Discrete Hausdorff 1","[discrete_hausdorff_1]") {
...
#if CGAL_BACKEND_ENABLED
    MovetkGeometryKernel::NT distance =  discrete_hausdorff(std::begin(polyline1), std::end(polyline1),
...
TEST_CASE("Check Discrete Hausdorff 2","[discrete_hausdorff_2]") {
...
TEST_CASE("Check Discrete Hausdorff 3","[discrete_hausdorff_3]") {
