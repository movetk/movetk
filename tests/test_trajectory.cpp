...
struct BaseTrajectoryTests {
    ...
    using TabularTrajectory = TabularTrajectory<std::string, int, float>;
};
...
TEST_CASE_METHOD(BaseTrajectoryTests, "TabularTrajectory construction with iterator range", "[construct_traj_with_iterator_range]") {
    ProbePoint p1 = { "abc", 1, 5.4 };
...
TEST_CASE_METHOD(BaseTrajectoryTests, "ColumnarTrajectory", "[columnartrajectory]") {
    ...
    ColumnarTrajectory<std::string, int, float, float> t{ data };
