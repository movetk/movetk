...
struct InterpolationTests : public test_helpers::BaseTestFixture<Backend> {
    ...
    using InterpolationTraits = InterpolationTraits<MovetkGeometryKernel, Projection, ProbeTraits, Norm>;
    using KinematicInterpolator = Interpolator<movetk_algorithms::kinematic_interpolator_tag,
...
MOVETK_TEMPLATE_LIST_TEST_CASE_METHOD(InterpolationTests, "kinematic trajectory interpolation 1", "[kinematic_trajectory_interpolation_1]") {
    struct ProbeTraits {
        enum ProbeColumns {
            SAMPLE_DATE, LAT, LON, HEADING, SPEED
        };
...
MOVETK_TEMPLATE_LIST_TEST_CASE_METHOD(InterpolationTests, "kinematic trajectory interpolation 2", "[kinematic_trajectory_interpolation_2]") {
