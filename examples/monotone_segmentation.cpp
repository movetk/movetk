...
public:
    static void show_usage(std::string& name) {
        std::cerr << "Usage: cat Trajectory | " << name << " <option(s)>\n"
                  ...
                  << "Output Format: <Id,Lat,Lon,Timestamp,Speed,Heading,X,Y,Distance,Velocity,LocationSegments,SpeedSegments,HeadingSegments,VelocitySegments,Distance_or_VelocitySegments> \n"
                  << "Threshold Format: <TSThreshold,RadiusThreshold,DifferenceThreshold,RangeThreshold> \n"
                  << "Column Idx: <IDColumnIdx,TSColumnIdx,LonColumnIdx,LatColumnIdx,XColumnIdx,YColumnIdx,SpeedColumnIdx,HeadingColumnIdx>"
                  << "Pre-Conditions:\n"
