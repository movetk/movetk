...
typedef movetk_algorithms::SegmentationTraits<MovetkGeometryKernel::NT, MovetkGeometryKernel, dimensions> SegmentationTraits;
...
struct IPTraits{
    ...
    ProbeTraits::ProbeColumns::SPEED, ProbeTraits::ProbeColumns::HEADING> LinearInterpolator;
