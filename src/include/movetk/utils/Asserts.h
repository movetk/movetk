...
#define ASSERT_RANDOM_ACCESS_ITERATOR(IteratorType)                                                                    \
	static_assert(                                                                                                       \
	    movetk::utils::is_random_access_iterator<typename std::iterator_traits<IteratorType>::iterator_category>::value, \
...
#define ASSERT_FORWARD_ITERATOR(IteratorType)                                                                    \
	static_assert(                                                                                                 \
	    movetk::utils::is_forward_iterator<typename std::iterator_traits<IteratorType>::iterator_category>::value, \
...
#define ASSERT_OUTPUT_ITERATOR(IteratorType)                                                                    \
	static_assert(                                                                                                \
	    movetk::utils::is_output_iterator<typename std::iterator_traits<IteratorType>::iterator_category>::value, \
...
#define ASSERT_NUMBER_TYPE(Kernel, Iterator) \
	static_assert(movetk::utils::is_NT<Kernel, decltype(*Iterator)>::value, "Expects Iterator over Kernel::NT")
...
#define ASSERT_IS_STRING(IteratorType) \
	static_assert(movetk::utils::is_string<typename IteratorType::value_type>::value, "Expects Iterator over std::string")
...
#define ASSERT_IS_SIZE_T(IteratorType) \
	static_assert(movetk::utils::is_size_t<typename IteratorType::value_type>::value, "Expects Iterator over std::size_t")
...
#define ASSERT_IS_EQUAL(T1, T2) \
	static_assert(movetk::utils::is_equal_to<T1, T2>::value, "Expects Iterator2 to be an iterator over Iterator1")

#define ASSERT_MIN_NORM(p) assert(p > 0)
