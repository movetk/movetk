...
namespace movetk_core
{
    ...
    /*!
     * @brief A specialization of is_random_access_iterator
    ...
    /*!
     * @brief A partial specialization of is_NT
    * @details sets value to true iff \c Type == \c const Kernel::NT&
    *
    *
    */
    ...
    /*!
     * @brief A partial specialization of is_NT
    * @details sets value to true iff \c Type == \c Kernel::NT
    *
    *
    */
    template <class Kernel>
