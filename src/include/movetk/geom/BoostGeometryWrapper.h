...
namespace movetk_support
{
    ...
    public:
        ...
        Wrapper_Boost_Segment(Wrapper_Boost_Point<Kernel> &p1,
                              Wrapper_Boost_Point<Kernel> &p2)
        {
    ...
    public:
        ...
        Wrapper_Boost_Line(Wrapper_Boost_Point<Kernel> &p1,
                           Wrapper_Boost_Point<Kernel> &p2)
        {
    ...
    class Wrapper_Boost_Vector
    {
        ...
        Wrapper_Boost_Vector(Boost_Vector &vector)
        {
    ...
    public:
        ...
        Wrapper_Boost_Vector(const Wrapper_Boost_Point<Kernel> &p)
        {
            auto it = p.begin();
            size_t idx = 0;
            while (it != p.end())
        ...
        {
            Boost_Vector result;
            std::transform(this->begin(), this->end(), vector.begin(), result.begin(),
                           std::minus<typename Kernel::NT>());
            Wrapper_Boost_Vector v3(result);
            return v3;
        }
        ...
        Wrapper_Boost_Vector<Kernel> basis(std::size_t i)
        {
            Boost_Vector _e = {0};
            _e[i] = 1;
            Wrapper_Boost_Vector basis_vec(_e);
            return basis_vec;
        }
