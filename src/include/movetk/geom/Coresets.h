...
//
// Created by Mitra, Aniket on 24/01/2019.
//

#ifndef MOVETK_STREAMINGMEB_H
#define MOVETK_STREAMINGMEB_H
//
//template <class Kernel>
//class MebCoreset{
//private:
//     typename Kernel::Wrapper_Point center;
