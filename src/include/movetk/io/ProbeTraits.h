...
#ifndef MOVETK_PROBETRAITS_H
#define MOVETK_PROBETRAITS_H


template <class _ProbeColumns, class _ProbeParseDate, class _ProbeCsv, class _ProbePoint,
        bool _header = true, char _delimiter = ','>
struct _ProbeTraits {
