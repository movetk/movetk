...
namespace movetk_support {
    ...
    private:
        ...
        template<class InputIterator>
        void identify_free_vertices(InputIterator first, InputIterator beyond,
                                    typename CellTraits::GeometryTraits::MovetkSegment S,
                                    std::size_t edge_id) {

            if ((edge_id != CellTraits::edge_orientation::Left) &&
                (edge_id != CellTraits::edge_orientation::Right))
                return;
    ...
    public:
        ...
        FreeSpaceCell(typename CellTraits::GeometryTraits::MovetkSegment P,
            ...
            update_edge_id(std::begin(intersections) + init_length, std::end(intersections),
                           CellTraits::edge_orientation::Left);
            identify_free_vertices(std::begin(intersections) + init_length, std::end(intersections),
                                   P, CellTraits::edge_orientation::Left);
            ...
            update_edge_id(std::begin(intersections) + init_length, std::end(intersections),
                           CellTraits::edge_orientation::Top);
            init_length = new_length;
            ...
            identify_free_vertices(std::begin(intersections) + init_length, std::end(intersections),
                                   P, CellTraits::edge_orientation::Right);;
            init_length = new_length;
            ...
            update_edge_id(std::begin(intersections) + init_length,
                           std::end(intersections), CellTraits::edge_orientation::Bottom);
            init_length = new_length;
         ...
         * @return
         */
        typename CellTraits::vertex_iterator vertices_begin() {
         ...
         * @return
         */
        typename CellTraits::vertex_iterator vertices_end() {
         ...
         * @return
         */
        typename CellTraits::const_iterator begin() {
            return std::begin(intersections);
        }
         ...
         * @return
         */
        typename CellTraits::const_iterator end() {
            return std::end(intersections);
        }
    ...
    public:
        ...
        template<class InputIterator>
        FreeSpaceDiagram(InputIterator polyline_p_first, InputIterator polyline_p_beyond,
                         InputIterator polyline_q_first, InputIterator polyline_q_beyond,
        ...
        typename FreeSpaceDiagramTraits::iterator begin() {
            return typename FreeSpaceDiagramTraits::iterator(std::begin(rows));
        }
