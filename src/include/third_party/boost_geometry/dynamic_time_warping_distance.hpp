...
#ifndef BOOST_GEOMETRY_ALGORITHMS_DYNAMIC_TIME_WARPING_DISTANCE_HPP
#define BOOST_GEOMETRY_ALGORITHMS_DYNAMIC_TIME_WARPING_DISTANCE_HPP

#include <algorithm>

#ifdef BOOST_GEOMETRY_DEBUG_DYNAMIC_TIME_WARPING_DISTANCE
#include <iostream>
#endif
...
namespace detail { namespace dynamic_time_warping_distance
{
...
}} // namespace detail::dynamic_time_warping_distance
...
>
struct dynamic_time_warping_distance : not_implemented<Tag1, Tag2>
{};

// Specialization for point and multi_point
template <typename Point, typename MultiPoint>
struct dynamic_time_warping_distance<Point, MultiPoint, point_tag, multi_point_tag>
    : detail::dynamic_time_warping_distance::point_range
{};

// Specialization for linestrings
template <typename Linestring1, typename Linestring2>
struct dynamic_time_warping_distance<Linestring1, Linestring2, linestring_tag, linestring_tag>
    : detail::dynamic_time_warping_distance::range_range
{};

// Specialization for multi_point-multi_point
template <typename MultiPoint1, typename MultiPoint2>
struct dynamic_time_warping_distance<MultiPoint1, MultiPoint2, multi_point_tag, multi_point_tag>
    : detail::dynamic_time_warping_distance::range_range
{};
...
/*!
\brief Calculate dynamic time warping_distance between two geometries (currently
    works for LineString-LineString, MultiPoint-MultiPoint, Point-MultiPoint) using specified strategy.
\ingroup dynamic_time_warping_distance
...
\qbk{[include reference/algorithms/dynamic_time_warping_distance.qbk]}
...
[heading Example]
[dynamic_time_warping_distance_strategy]
[dynamic_time_warping_distance_strategy_output]
}
*/
...
typename distance_result
    <
        ...
        Strategy
    >::type
dynamic_time_warping_distance(Geometry1 const& geometry1,
                            Geometry2 const& geometry2,
                            Strategy const& strategy)
{
    return dispatch::dynamic_time_warping_distance
        <
            Geometry1, Geometry2
...
[dynamic_time_warping_distance_output]
}
*/
                            ...
                            Geometry2 const& geometry2)
{
    ...
    return dynamic_time_warping_distance(geometry1, geometry2, strategy_type());
}

}} // namespace boost::geometry

#endif // BOOST_GEOMETRY_ALGORITHMS_DYNAMIC_TIME_WARPING_DISTANCE_HPP
