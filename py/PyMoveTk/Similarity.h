	...
	static void register_distances(pybind11::module& mod) {
		...
		mod.def(
		    ...
		    [](const Polyline& p0, const Polyline& p1) -> std::size_t {
			    movetk::metric::Discrete_Hausdorff<MoveTkKernel, typename GeometryKernel::Norm> discrete_hausdorff;
		...
		mod.def(
		    ...
		    [](const Polyline& p0, const Polyline& p1) -> std::size_t {
			    movetk::metric::Discrete_Frechet<MoveTkKernel, typename GeometryKernel::Norm> discrete_frechet;
