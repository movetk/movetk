function(OneOfTargetsExists SUCCESS_VAR TARGET_VAR)
    foreach(_ARG IN LISTS ARGN)
        if(TARGET ${_ARG})
            ...
            message(STATUS "Target ${_ARG} exists")
            return()
        else()
            message(STATUS "Target ${_ARG} does not exist")
        endif()
    endforeach()
...
macro(CreateImportTarget NAME)
    if(NOT TARGET ${NAME}::${NAME})
        ...
        if(NOT ${_TARGET_FOUND})
            ...
            message(STATUS "Include dirs: ${${NAME}_internal_INCLUDE_DIRS}")
            message(STATUS "Libs: ${${NAME}_internal_LIBS}")
