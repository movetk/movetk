...
foreach(_expectedTarget GsTL::GsTL)
...
message(STATUS "import_prefix ${_IMPORT_PREFIX}")

# Create imported target Catch2::Catch2
add_library(GsTL::GsTL INTERFACE IMPORTED)

set_target_properties(GsTL::GsTL PROPERTIES
...
file(GLOB CONFIG_FILES "${_DIR}/GsTLTargets-*.cmake")
